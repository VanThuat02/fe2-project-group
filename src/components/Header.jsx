...
const Header = () => {
    ...
    // simple function to toggle the mibile menu
    const toggleMobileMenu = () => {
        //get the mobile Menu element
        const mobileMenu = document.getElementById("mobileMenu")


        // If it has the "hidden", class, remove it, Otherwise
    ...
    return (
        ...
        items-center sticky top-0 z-50 w-full border-b-[0.3px] border-[#babaff] bg-black">
            ...
            <div className="flex lg:gap-14 gap-4">
                ...
                items-center">
                   ...
                   to-gray-400 rounded-lg font-medium text-nowrap hover:opacity-70
                   transition-all duration-300 ">
                        PLAY NOW
                    </button>
                </div>
            ...
            <nav className=' hidden md:flex lg:gap-8 gap-4'>
                ...
                after:transition-all hover:after:w-full text-nowrap ">
                    <i class='bx bx-user-circle'></i> Avarta
                </a>
                ...
                after:bg-purple-400 after:left-0 after:bottom-0 
                after:transition-all hover:after:w-full text-nowrap ">
                    <i class='bx bxl-graphql'></i> Arena
                </a>
                ...
                after:bg-purple-400 after:left-0 after:bottom-0 
                after:transition-all hover:after:w-full text-nowrap ">
                    <i class='bx bx-chevrons-up'></i> Beyound
                </a>
