...
const Hero = () => {
    return (
        ...
        overflow-hidden flex justify-center md-[10%]'>
            ...
            flex-col items-center gap-5'>
                ...
                <h1 className='md:text-2xl text-lxl font-bold'>
                    Explore, Capture, Conquuer
                </h1>

                <div className='md:w-[75%] w-[60%] h-[0.1px] bg-[#haha]'></div>

                <button className="h-10 px-16
            ...
            right-5 mt-24 animate-bounce sm:inline-block hiddq'>
                <div className='flex flex-col items-center'>
                    <div className='w-8 h-12 border-2 border-[#babaff] rounded-full
